...
import { CLASSIFY_SIZE, MIN_REFINED_SCORE } from './constants';
import { modelDestRect, type ScreenRect } from './boxLayout';
...
export async function classifyCrop(
  ...
  //
  // Khối này ĐỒNG BỘ và tốn ~126ms trên máy tầm trung (Skia đọc 640² pixel rồi
  // tách kênh), nên nơi gọi phải hoãn nó ra khỏi lúc đang có animation.
